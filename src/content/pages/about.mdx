...
<PreviewGrid columns={2} postSlugs={[
  { id: "project/noteworthy", span: 2 },
  { id: "project/prosemirror-math", span: 1 },
  { id: "project/remark-cite", span: 1 },
]} />
...
<PreviewGrid columns={2} postSlugs={[
  { id: "project/type-safari", span: 1 },
  { id: "project/borscht", span: 1 },
]} />
...
<PreviewGrid columns={2} postSlugs={[
  { id: "project/prosemirror-math", span: 1, show: { image: false } },
  { id: "project/remark-cite", span: 1, show: { image: false } },
]} />
