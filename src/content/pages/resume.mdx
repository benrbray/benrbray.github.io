...
I enjoy the expressiveness and safety that comes with pure, statically-typed functional programming.  Learning Haskell has had a big positive impact on how I solve problems
...
<PostPreview postSlug="project/flash-games" />
...
* I've worked professionally with both the `react` and `solid-js` frameworks.

<PostPreview postSlug="project/noteworthy" />
...
<PostPreview postSlug="project/remark-cite" />

<PostPreview postSlug="project/prosemirror-math" />
