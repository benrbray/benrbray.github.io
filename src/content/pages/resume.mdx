...
* Building new **development tools**, including language servers, type inference, and static code analysis.  I'm excited by modern dependently-typed languages like `lean`, and hope to see interactive theorem proving become more popular in industry.
...
* In my free time, I enjoy learning about **dependently-typed** languages like Coq, Idris and Lean.  I created the toy language [`yagi-lang`](https://github.com/benrbray/yagi-lang) to learn more about dependent type theory.
