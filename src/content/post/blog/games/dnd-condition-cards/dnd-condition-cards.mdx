...
published: True
summary: >
   In my weekly D&D group, I play a Paladin who often casts support spells
   to buff allies in combat.  It's not always easy to remember which effects
   are active at any given time, so I created a custom deck of **condition cards**
   to help keep track!
...
![](./images/assembly-crease-process.png)
![](./images/assembly-crease-guides-closeup.png)
...
![](./images/assembly-after-gluing-2.jpg)
...
![](./images/assembly-outer-laminate-sheet.jpg)
![](./images/assembly-outer-laminate-inprogress.png)
![](./images/assembly-outer-laminate-fronts.png)
![](./images/assembly-outer-laminate-backs.png)

## Cutting Left and Bottom Edges Individually

![](./images/assembly-corner-align-before-cut-2.png)
