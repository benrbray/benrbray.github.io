...
published: true
summary: My weekly D&D group has been playing more often at bars, without room for map grids or minis.  I designed a compact set of tokens to help combat run smoothly with limited table space!
...
![](./images/tokens-closeup-1.png)
{/* ![](./images/tokens-closeup-4.png) */}

For comparison, the charming-but-flimsy sticky notes we used before:

![](./images/crocodiles.png)

## Cutting Label Paper with the Silhouette Cameo

I created a print-and-cut template in Inkscape, with registration marks on three corners which the Cameo machine can use to precisely cut stickers from the printed sheet.

![](./images/tokens_cameo-cut-template.svg)
![](./images/assembly-cameo-1.png)
![](./images/label-closeup-3.png)

# Precisely Positioning the Stickers

![](./images/assembly-tweezers-3a.png)
![](./images/tokens-result-1.png)